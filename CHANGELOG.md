...
- Sample scripts: `agent-sandbox-wrapper.sh`, `agent-isolation-policy-check.sh`, `claude-pretooluse-validator.sh`, `cursor-before-read-guard.sh`, `cursor-before-shell-guard.sh`, `test-validator.sh`
