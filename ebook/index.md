...
Ready to begin? Start with the [About This Book](about.md) page, or jump directly to [Part I – Bash Fundamentals](part1_bash_fundamentals/00_part1_bash_fundamentals.md).

## Download Formats

This book is also available in downloadable formats. Visit the [Latest Release](https://github.com/samerfarida/secure-bash-macos-ebook/releases/latest) to download:
