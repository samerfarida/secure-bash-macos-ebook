...
|-------|-------------|------|
| **Learning the Bash Shell** (O'Reilly) | Classic introduction to Bash scripting fundamentals | [O'Reilly](https://www.oreilly.com/library/view/learning-the-bash/0596009658/) |
| **Classic Shell Scripting** (O'Reilly) | Deeper look at shell scripting philosophy and patterns | [O'Reilly](https://www.oreilly.com/library/view/classic-shell-scripting/0596005954/) |
...
|----------|-------------|------|
| **Bash Manual** | Official Bash GNU manual | [https://www.gnu.org/software/bash/manual/](https://www.gnu.org/software/bash/manual/) |
...
|-----------|-------------|------|
| **Stack Overflow (bash tag)** | Active Q&A for Bash scripting | [https://stackoverflow.com/questions/tagged/bash](https://stackoverflow.com/questions/tagged/bash) |
| **MacAdmins Slack** | Large community for macOS admins | [https://www.macadmins.org/](https://www.macadmins.org/) |
